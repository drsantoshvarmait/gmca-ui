...
BEGIN
    ...
    LOOP
        ...
        ) ON CONFLICT (course_name, annual_intake, category) DO UPDATE SET requirement_logic = EXCLUDED.requirement_logic;
...
async function run() {
    try {
        ...
        console.log("Migration: Fully populated Missing Regulations for 50/100/200/250 seats.");
    } catch (err) {
