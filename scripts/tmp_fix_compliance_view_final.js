...
async function run() {
    ...
    try {
        ...
        console.log('Re-creating vw_organisation_compliance_report with correct multi-tenant blueprint path...');
        
        await client.query("DROP VIEW IF EXISTS public.vw_organisation_compliance_report");
        ...
        SELECT 
            ...
            rb.resource_type,
            rb.id as resource_blueprint_id,
            rb.resource_name,
        ...
        JOIN public.organisation_types ot ON o.organisation_type_id = ot.organisation_type_id
        JOIN public.organisation_type_units u ON o.organisation_type_id = u.organisation_type_id
        JOIN public.organisation_unit_sub_units s ON s.parent_unit_id = u.id
