    ...
    <>
      ...
      >
        ...
        >
          ...
          <span style={{
            backgroundColor: (window.location.hostname.includes("staging.vercel.app") || import.meta.env.VITE_APP_ENV === "STAGING") ? "#f59e0b" :
              (window.location.hostname === "gmca-ui.vercel.app" || import.meta.env.VITE_APP_ENV === "PROD") ? "#ef4444" : "#3b82f6",
            color: "white",
            padding: "2px 8px",
            borderRadius: "4px",
            fontSize: "10px",
            ...
            {(window.location.hostname.includes("staging.vercel.app") || import.meta.env.VITE_APP_ENV === "STAGING") ? "STAGING" :
